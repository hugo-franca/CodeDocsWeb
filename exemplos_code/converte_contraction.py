...
nomeArquivoBase = "ContractionFlow.sim"
nomeNovoArquivo = "html_Contraction.txt"
...
def formataLinha(linha):
	...
	if( indiceLinhaAtual==0 ):
		...
		output_total = stringParse.format(tipo, vertices, parametros1, parametros2)
		...
		parametros4 = tooltipString(resultado[5], dict_tooltips['mesh_geom_parameters'])
		parametros5 = tooltipString(resultado[6], dict_tooltips['mesh_geom_parameters'])
		parametros6 = tooltipString(resultado[7], dict_tooltips['mesh_geom_parameters'])
		
		output_total = stringParse.format(tipo, vertices, parametros1, parametros2, parametros3, parametros4, parametros5, parametros6)
	elif( indiceLinhaAtual>=17 and indiceLinhaAtual<=24 ):
		...
		output_total = stringParse.format(tipo, numfaces, face_0)
	else:
		output_total = linha
